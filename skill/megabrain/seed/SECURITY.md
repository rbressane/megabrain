...
- A paired harness may deliver only after exact owner approval and cryptographic destination attestation. The model never supplies context, destination, approval, signature, or attestation fields and receives only a value-free receipt.
